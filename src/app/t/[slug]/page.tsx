  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-x-hidden" style={{ backgroundColor: '#060607', color: '#e3e2e7', fontFamily: "'Geist', sans-serif" }}>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-start pt-[max(6rem,calc(50vh-300px))] px-4 md:px-12 pb-12 min-h-[100dvh]">
        <div className={`w-full max-w-[1200px] grid grid-cols-1 ${(track.youtube_id || track.google_drive_file_id === 'youtube_video') ? 'lg:grid-cols-1 gap-8 lg:gap-10' : 'lg:grid-cols-[auto_1fr] gap-10 lg:gap-12 xl:gap-16'} items-stretch mx-auto`}>
          
          {/* COVER ART or YOUTUBE EMBED */}
          <div className={`relative w-full transition-all duration-500 ${(track.youtube_id || track.google_drive_file_id === 'youtube_video') ? 'mx-0 max-w-none order-1' : 'mx-auto max-w-[320px] sm:max-w-[380px] lg:max-w-[400px] xl:max-w-[500px]'}`}>
